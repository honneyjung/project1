...
(function (e) {
    ...
    (e.widget.bridge = function (t, i) {
      ...
      e.fn[t] = function (a) {
        var n = "string" == typeof a,
          ...
          r = this;
        return (
          (a = !n && o.length ? e.widget.extend.apply(null, [a].concat(o)) : a),
          n
            ? this.each(function () {
                var i,
                  n = e.data(this, s);
      ...
      option: function (t, i) {
        ...
        if ("string" == typeof t)
          if (((o = {}), (s = t.split(".")), (t = s.shift()), s.length)) {
            for (
              a = o[t] = e.widget.extend({}, this.options[t]), n = 0;
              s.length - 1 > n;
              n++
            )
              (a[s[n]] = a[s[n]] || {}), (a = a[s[n]]);
          ...
          e.each(s, function (s, o) {
            function r() {
              return t ||
                ...
                ? ("string" == typeof o ? n[o] : o).apply(n, arguments)
                : void 0;
            }
            "string" != typeof o &&
          ...
          flip: {
            left: function (e, t) {
              var i,
                ...
                f = -2 * t.offset[0];
              0 > u
                ? ((i = e.left + c + p + f + t.collisionWidth - o - n),
            ...
            top: function (e, t) {
              var i,
                ...
                m = -2 * t.offset[1];
              0 > u
                ? ((s = e.top + p + f + m + t.collisionHeight - o - n),
                  e.top + p + f + m > u &&
                    (0 > s || r(u) > s) &&
                    (e.top += p + f + m))
                : d > 0 &&
    ...
    e.ui.plugin.add("resizable", "containment", {
      ...
      resize: function (t) {
        ...
        c[0] !== document && /static/.test(c.css("position")) && (d = h),
          ...
          (a = o.containerElement.get(0) === o.element.parent().get(0)),
      ...
      stop: function () {
        ...
        t._helper &&
          ...
          e(this).css({ left: r.left - a.left - s.left, width: h, height: l }),
          t._helper &&
            !i.animate &&
          ...
          /^(se|s|e)$/.test(r)
            ...
            : ((0 >= f - u || 0 >= p - l) &&
              ...
              p - l > 0
                ...
                : ((p = u - t.height),
                  (i.size.width = p),
                  (i.position.left = o.left + n.width - p)));
      },
    }),
    e.ui.resizable,
      ...
      _mouseDrag: function (t) {
        if (((this.dragged = !0), !this.options.disabled)) {
          ...
          return (
            n > r && ((i = r), (r = n), (n = i)),
            o > h && ((i = h), (h = o), (o = i)),
            this.helper.css({ left: n, top: o, width: r - n, height: h - o }),
            this.selectees.each(function () {
              ...
              i &&
                ...
                ("touch" === a.tolerance
                  ...
                  : "fit" === a.tolerance &&
                    (l =
                      i.left > n && r > i.right && i.top > o && h > i.bottom),
                l
                  ? (i.selected &&
        ...
        if (l && t)
          for (s = l.length - 1; s >= 0; s--)
            for (n = e(l[s]), a = n.length - 1; a >= 0; a--)
              (o = e.data(n[a], this.widgetFullName)),
                o &&
                  o !== this &&
                  !o.options.disabled &&
                  h.push([
        ...
        return (
          ...
          this.originalPosition &&
            ...
            a.grid &&
              ((i =
                this.originalPageY +
                Math.round((o - this.originalPageY) / a.grid[1]) * a.grid[1]),
              (o = this.containment
  ...
  e.extend(a.prototype, {
    ...
    _checkOffset: function (t, i, s) {
      ...
      return (
        (i.left -= this._get(t, "isRTL") ? a - o : 0),
        (i.left -=
      ...
      !o ||
        ...
        (this._datepickerShowing &&
          ...
          e.effects && (e.effects.effect[i] || e.effects[i])
            ? o.dpDiv.hide(i, e.datepicker._get(o, "showOptions"), s, a)
            : o.dpDiv[
                "slideDown" === i
                  ? "slideUp"
                  : "fadeIn" === i
        ...
        n = function (i) {
          ...
          for (
            ...
            switch (l[2] || "d") {
              ...
              case "M":
                (o += parseInt(l[1], 10)),
                  (r = Math.min(r, e.datepicker._getDaysInMonth(n, o)));
                break;
              case "y":
              case "Y":
                (n += parseInt(l[1], 10)),
        ...
        for (k = "", this.maxRows = 4, T = 0; V[1] > T; T++) {
          ...
          for (
            N +=
              ...
              S +
              "'>" +
              (/all|left/.test(S) && 0 === w ? (Y ? n : s) : "") +
              (/all|right/.test(S) && 0 === w ? (Y ? s : n) : "") +
  ...
  (e.effects = { effect: {} }),
        ...
        function (t, i) {
          e.fx.step[i] = function (e) {
            (("none" !== e.end && !e.setAttr) || (1 === e.pos && !e.setAttr)) &&
              (p.style(e.elem, i, e.end), (e.setAttr = !0));
          };
        }
      ),
        e.fn.addBack ||
    ...
    (e.effects.effect.pulsate = function (t, i) {
      var s,
        ...
        p = c.length;
      for (
        (o || !a.is(":visible")) && (a.css("opacity", 0).show(), (d = 1)),
          s = 1;
        l > s;
        s++
      )
